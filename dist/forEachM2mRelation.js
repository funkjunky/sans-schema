export default ((modelName, m2mModels, cb) => {
  const m2mRelationships = Object.entries(m2mModels).filter(([m2mKey, relationships]) => Object.keys(relationships).includes(modelName));
  m2mRelationships.forEach(([m2mKey, relationships]) => {

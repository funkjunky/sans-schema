...
export const mergeData = (oldModels, newModels) => produce(oldModels, draftState =>
Object.values(newModels).forEach(newModel =>
  oldModels[newModel.id] =
    oldModels[newModel.id]
        // if old model exists, then merge new model into old model
